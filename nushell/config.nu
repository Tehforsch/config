...
alias dlc = ~/projects/config/scripts/copyLastDownload.sh
alias e = ~/projects/config/scripts/runEmacsClientInPwd.sh
...
alias timer = ~/projects/config/scripts/timer/timer.sh
alias timerAt = ~/projects/config/scripts/timer/timerAt.sh
